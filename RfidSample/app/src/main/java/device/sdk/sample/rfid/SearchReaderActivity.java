...
public class SearchReaderActivity extends AppCompatActivity
{
    ...
    private device.sdk.sample.rfid.adapter.RFIDListAdapter mListAdapter;
    ...
    private Utils mUtil;
    private device.sdk.sample.rfid.util.PreferenceUtil mPrefUtil;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mPrefUtil = new device.sdk.sample.rfid.util.PreferenceUtil(getApplicationContext());
        mProgressDlg = new ProgressDialog(device.sdk.sample.rfid.SearchReaderActivity.this);
    ...
    private void init()
    {
        ...
        mListAdapter = new device.sdk.sample.rfid.adapter.RFIDListAdapter(getApplicationContext());
    ...
    private void startSearchDevice()
    {
        ...
        mProgressSearchDlg = new ProgressDialog(device.sdk.sample.rfid.SearchReaderActivity.this);
    ...
    private Handler mHandlerBtConnect = new Handler()
    {
        ...
        public void dispatchMessage(Message msg)
        {
            if(mRfidMgr != null && !mRfidMgr.IsOpened())
            {
                ...
                Log.d(TAG, "disconn5");
                mUtil.showProgress(mProgressDlg, device.sdk.sample.rfid.SearchReaderActivity.this, false);
            }
    ...
    public void requestRfidConnection(int index)
    {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(device.sdk.sample.rfid.SearchReaderActivity.this);
        ...
        builder.setPositiveButton(R.string.connect, new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                mUtil.showProgress(mProgressDlg, device.sdk.sample.rfid.SearchReaderActivity.this, connMsg, true);
    ...
    public void requestRfidDisConnection(final int index)
    {
        ...
        if(btDevice.getAddress().equalsIgnoreCase(macAddr))
        {
            ...
            builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener()
            {
                ...
                public void onClick(DialogInterface dialog, int which)
                {
                    String currentMac = mPrefUtil.getStringPreference(device.sdk.sample.rfid.util.PreferenceUtil.KEY_CONNECT_BT_MACADDR);
    ...
    public class AsyncRfidOpen extends AsyncTask<Void, Void, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... voids)
        {
            ...
            if(result)
            {
                ...
                if(macAddr != null && !macAddr.isEmpty())
                    mPrefUtil.putStringPrefrence(device.sdk.sample.rfid.util.PreferenceUtil.KEY_CONNECT_BT_MACADDR, macAddr);

                if(deviceName != null && !deviceName.isEmpty())
                    mPrefUtil.putStringPrefrence(device.sdk.sample.rfid.util.PreferenceUtil.KEY_CONNECT_BT_NAME, deviceName);
            }
            return result;
        }
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if(result)
            {
                String btName = mPrefUtil.getStringPreference(device.sdk.sample.rfid.util.PreferenceUtil.KEY_CONNECT_BT_NAME, "");
