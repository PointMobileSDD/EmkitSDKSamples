...
public class RFIDApplication extends Application
{
    ...
    public final String RFID_CONTROL_ACTIVITY = "device.sdk.sample.rfid.RFIDControlActivity";
    public final String RFID_DEMO_ACTIVITY = "device.sdk.sample.rfid.RFIDDemoActivity";

    private static device.sdk.sample.rfid.RFIDApplication mRFIDApplication;
